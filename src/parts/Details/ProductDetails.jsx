      ...
      <div className="flex flex-wrap my-4 md:my-12">
            ...
            <div className="thumbnail">
              <div className="px-2">
                <div
                  ...
                  data-img="/assets/images/content/chair-1.jpg"
                >
                  <img
                    src="/assets/images/content/chair-1.jpg"
                    alt="Chair Thatty"
              ...
              <div className="px-2">
                <div
                  className="item"
                  data-img="/assets/images/content/chair-2.jpg"
                >
                  <img
                    src="/assets/images/content/chair-2.jpg"
                    alt="Chair Thatty"
                    className="object-cover w-full h-full rounded-lg"
                  />
                </div>
              ...
              <div className="px-2">
                <div
                  className="item"
                  data-img="/assets/images/content/chair-3.jpg"
                >
                  <img
                    src="/assets/images/content/chair-3.jpg"
                    alt="Chair Thatty"
                    className="object-cover w-full h-full rounded-lg"
                  />
                </div>
        ...
        <div className="flex-1 px-4 md:p-6">
          <div className="hidden md:block">
            <h2 className="text-5xl font-semibold">Chair Tatty</h2>
